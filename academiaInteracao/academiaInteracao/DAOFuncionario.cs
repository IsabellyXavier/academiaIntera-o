    ...
    class DAOFuncionario
    {
        ...
        public void Inserir(long cpf, string nome, string telefone, string endereco)
        {
            try
            {
                ...
                comando = "Insert into Funcionario(codigoF, nome, CPF , telefone, endereco) values " + dados;
        ...
        {
            string query = "select * from Funcionario";//comand para coletar todos os dados do banco

            //instanciando os vetores
            vetorCodigoF = new int[100];
            ...
            {
                vetorCodigoF[i] = Convert.ToInt32(leitura["codigoF"]);
        ...
        public int ConsultarCodigo()
        {
            ...
            return vetorCodigoF[contarCodigo];
        ...
        public void Atualizar(int cod, string campo, long novoDado)
        {
            try
            {
                string query = "update Funcionario set " + campo + " = '" + novoDado + "' where codigoF = '" + cod + "'";
        ...
        public void Deletar(int cod)
        {
            try
            {
                string query = "delete from Funcionario where codigoF = '" + cod + "'";
